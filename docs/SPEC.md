...
- Each feedback effect and the sound can be switched off in settings. Since M5d that includes an **Effects** switch (particles, ambient embers and the moving background; see section 11, M5d).
